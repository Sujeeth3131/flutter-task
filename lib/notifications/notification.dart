...
class Notifications_New extends StatefulWidget {
  const Notifications_New({super.key, this.title});

  final String? title;

  @override
  State<Notifications_New> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Notifications_New> {
