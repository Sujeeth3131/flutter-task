...
class NetworkHand extends StatefulWidget {
  const NetworkHand({super.key, this.title});

  final String? title;

  @override
  State<NetworkHand> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<NetworkHand> {
